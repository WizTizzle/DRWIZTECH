...
export function Header() {
  ...
  // Load saved logo position from localStorage
  const logoSize = Number(localStorage.getItem('logo-size-fixed')) || 104;
  const logoMargin = Number(localStorage.getItem('logo-margin-fixed')) || 10;
  const logoRotation = Number(localStorage.getItem('logo-rotation-fixed')) || 0;
  const logoX = Number(localStorage.getItem('logo-x-fixed')) || 0;
  const logoY = Number(localStorage.getItem('logo-y-fixed')) || 0;
