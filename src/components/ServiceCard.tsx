  ...
  return (
    <Link to={link} className="block">
      ...
      >
        ...
        <motion.div 
          className="flex items-center justify-center w-16 h-16 bg-primary-300/10 rounded-xl mb-8 relative"
        ...
        <h3 className="text-2xl font-display font-semibold mb-4 text-gray-900 group-hover:text-primary-600 transition-colors duration-500 relative">{title}</h3>
        <p className="text-gray-600 leading-relaxed mb-8 relative">{description}</p>
        
        <div className="flex items-center text-primary-300 font-medium relative group-hover:translate-x-2 transition-transform duration-500">
