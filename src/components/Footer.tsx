    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                <Lightbulb className="text-primary-300" size={32} />
                <h3 className="text-2xl font-display font-bold">WizTech</h3>
              </div>
            ...
            <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div variants={itemVariants}>
                ...
                <ul className="space-y-3 text-gray-400">
                  <li>support@wiztechrecovery.com</li>
                  <li>+1 (555) 123-4567</li>
                  <li>123 Recovery Lane</li>
          ...
          >
            <p>&copy; {new Date().getFullYear()} WizTech Data Recovery. All rights reserved.</p>
          </motion.div>
        </motion.div>
      </div>
    </footer>
